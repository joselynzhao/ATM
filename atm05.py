...
def main(args):
    ...
    for step in range(args.total_step+1): #加1是为了保证所有的数据都能加入到训练集中
        ...
        pred_y, pred_score, label_pre = reid.estimate_label(u_data, s_data+l_data)  # 针对u_data进行标签估计
        ...
        tpred_y, tpred_score, tlabel_pre = tagper.estimate_label(u_data, s_data+l_data)
